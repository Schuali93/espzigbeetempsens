#ifndef ESP_ZB_TEMPERATURE_SENSOR_H
#define ESP_ZB_TEMPERATURE_SENSOR_H
...
#define ESP_HUM_SENSOR_MIN_VALUE        (0)     /* Local sensor min measured value (percent) */
#define ESP_HUM_SENSOR_MAX_VALUE        (100)   /* Local sensor max measured value (percent) */

/* Attribute values in ZCL string format
 * The string should be started with the length of its own.
 */
#define MANUFACTURER_NAME               "\x09""ESPRESSIF"
#define MODEL_IDENTIFIER                "\x07""DHT22"
...
#endif // ESP_ZB_TEMPERATURE_SENSOR_H
